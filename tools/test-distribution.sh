...
mkdir -p "$fixture/tools" "$fixture/drive-health-plugin/scripts" \
  "$fixture/drive-health-plugin/translations"
...
cp "$repo_root/drive-health-plugin/plugin.toml" "$fixture/drive-health-plugin/plugin.toml"
cp "$repo_root/drive-health-plugin/README.md" "$fixture/drive-health-plugin/README.md"
cp "$repo_root/drive-health-plugin/collector.luau" "$fixture/drive-health-plugin/collector.luau"
for file in service.luau history.luau widget.luau panel.luau; do
  cp "$repo_root/drive-health-plugin/$file" "$fixture/drive-health-plugin/$file"
done
cp "$repo_root/drive-health-plugin/translations/en.json" \
  "$fixture/drive-health-plugin/translations/en.json"
cp "$repo_root/drive-health-plugin/scripts/collect_raw.sh" \
  "$fixture/drive-health-plugin/scripts/collect_raw.sh"
